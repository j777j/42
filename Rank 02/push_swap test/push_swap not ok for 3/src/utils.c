...
/*   Updated: 2025/07/06 12:30:00 by juwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * is_sorted: Checks if a stack is sorted in descending order, which is the
 *            correct sorted state for our stack 'a' implementation where
 *            the top element should be the largest.
 */
