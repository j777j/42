...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/20 13:27:49 by juwang            #+#    #+#             */
/*   Updated: 2025/07/20 13:36:50 by juwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	process_tile_for_count(t_game *game, t_tile_data *data)
{
	...
	else if (data->c == COLLECTIBLE)
		game->collectibles++;
	else if (data->c == EXIT)
		(*data->exits)++;
	else if (data->c == ENEMY)
		game->enemy_count++;
	else if (data->c != FLOOR && data->c != WALL)
	{
